# LOVING LOVE — Website Content
> Content extracted from https://www.lovinglove.com.au/ — section by section
> For use in the Next.js web app redesign
...
```
HOME | ABOUT ME | YOUR CEREMONY | MOMENTS & THOUGHTFUL WORDS | CONTACT ME | OTHER SERVICES
```
...
## 1. HOME PAGE
> URL: https://www.lovinglove.com.au/
...
**Link:**
- `Click here for more Thoughtful Words & Moments` → `/moments-testimonials`
...
## 2. ABOUT ME
> URL: https://www.lovinglove.com.au/about
...
## 3. YOUR CEREMONY
> URL: https://www.lovinglove.com.au/wedding-ceremony
...
> I register your marriage and lodge all legal documents with the Registry of Births, Deaths and Marriages within fourteen days from the date of your wedding. If requested by you, I apply for the Offical Certificate of Marriage on your behalf, at the same time of registering your marriage.
...
## 4. MOMENTS & THOUGHTFUL WORDS
> URL: https://www.lovinglove.com.au/moments-testimonials
...
## 5. CONTACT ME
> URL: https://www.lovinglove.com.au/contact
...
```
M: 0405 143 843
E: lena@lovinglove.com.au
```

---

### Contact Form Fields *(to include in the redesign)*
...
## 6. OTHER SERVICES
> URL: https://www.lovinglove.com.au/other-services-1
...
### Service 1 — Renewal of Marriage Vows
...
### Service 3 — Baby Naming Ceremony
...
## CLIENT NOTES — Lena's Vision
> Extracted from "Initial Info.md" — Obsidian vault

---

### Proposed Title

> Lena Saunig Loving Love - Authorised Marriage Celebrant - Celebrating love, and also life.

---

### Design & Content Preferences

- **Personality:** The site should feel personal and her personality and ease of connection should come through. It should not feel generic.
- **Style:** A balanced mix of personal and professional.
- **Clarity:** Clear sense of what she offers — the outcomes she enables, the process of doing so, and evidence around this.
- **Consistency:** Visually and linguistically consistent — colour tones, language, and design.
- **Tone:** What is written should feel like a conversation.
- **Design:** Simple, subtle, purposeful and easy to navigate. The overall brand vibe should be calm and focused on her craft, rather than loud, bold and overbearing.
- **Language:** Not interested in language that diminishes others' modes of delivery / negative undertones.
- **Photography & Illustrations:** Consistency in how they are presented across the site.
- **About Me:** Wants to step away from a traditional 'About Me' structure and instead flow organically into who she is.

---

### New Sections to Add

- **Favourite Venues & Trusted Partners** ✅
- **Celebrations of Life** *(new service to add to Other Services)*

---

### Desired Features

- Testimonials paired with a couple photo and possibly a short comment
- Ability for couples to leave Google Reviews
- AI Assistant *(to explore — Lena is unfamiliar with the concept and would prefer a face-to-face or FaceTime discussion before any decision)*

---

### Inspiration Websites

- https://www.marrymemichelle.com.au/
- https://celebrantsallyhughes.com.au/
- https://loveandlife.com.au/
- https://www.thesaltyshutter.com/
- https://rachelgutierrezphotography.com/

---

### Possible Dashboard — Enquiry Fields *(to be confirmed)*

These fields are intended for a future client enquiry dashboard — to be developed. They capture the key information Lena needs from couples before an initial conversation:
