...
export default function Footer() {
  ...
  return (
    <footer
      ref={footerRef}
      className="relative w-full overflow-hidden bg-white px-6 py-14 text-neutral-900 md:px-16 md:py-20 xl:px-24"
    >
      <div className="absolute left-1/2 top-0 h-px w-1/3 -translate-x-1/2 bg-neutral-900/10 blur-sm" />
      <div className="pointer-events-none absolute inset-x-0 top-0 h-40 bg-[radial-gradient(45%_140px_at_50%_0%,rgba(0,0,0,0.04),transparent)]" />
